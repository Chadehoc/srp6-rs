...
v    Password verifier
S    Session key
K    Session key hash                       (SHA1 interleaved)
...
3. The user must show his proof of `K` first.
...
/// Test values are defined in RFC 5054 appendix B.
///
...
pub mod testdata {
    ...
    /// From raw data (private keys, smaller) to BoxedUint
